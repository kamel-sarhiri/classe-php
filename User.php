...
class User {
    ...
    public function register($login, $password, $email, $firstname, $lastname)
    {
        ...
        if($login !== "" && $password !== "" && $email !=="" && $firstname !=="" && $lastname !=="" ){
            ...
            $error = "Veuillez saisir tous les champs (le login, le mot de passe, l'email, le prénom et le nom)";
    ...
    public function connect($login, $password)
    {
        if(!$this->isConnected()){
            ...
            if($login !== "" && $password !== ""){
                ...
                $error = "Veuillez saisir tous les champs (le login et le mot de passe)";
                return $error; // utilisateur ou mot de passe vide
            }
        }
        else{
    ...
    public function delete()
    {
        ...
        if($this->isConnected()){
            ...
            $error = "NON CONNECTE, veuillez vous connecter pour supprimer le compte";
    ...
    public function update($login, $password, $email, $firstname, $lastname)
    {
        ...
        if($this->isConnected()){
            ...
            $error = "NON CONNECTE, veuillez vous connecter pour modifier le compte";
            return $error; // utilisateur non connecté
        }
    }
    ...
    public function getAllInfos()
    {
        ...
        if($this->isConnected()){
            ...
            echo "NON CONNECTE, veuillez vous connecter pour modifier le compte";
        }
    }
...
<body>
    ...
    <?php
        ...
        // Test du register
        //echo $user->register('test', 'test', 'test@test.com', 'prenom_test', 'nom_test');
        ...
        // Test du update
        //echo $user->update('testbis', 'testbis', 'testbis@test.com', 'prenom_testbis', 'nom_test_bis');
