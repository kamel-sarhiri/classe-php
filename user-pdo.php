...
class Userpdo {
    ...
    public function __construct() 
    {
        ...
        // si erreur, capture des exceptions, s'il y en => affichage des infos
    ...
    public function register($login, $password, $email, $firstname, $lastname)
    {
        if($login !== "" && $password !== "" && $email !=="" && $firstname !=="" && $lastname !=="" ){
            ...
            // exécution requête avec liaison des paramètres
...
<body>
    ...
    <?php
        ...
        // Test du register
        //echo $user->register('testPDObis', 'testPDObis', 'testPDObis@test.com', 'prenom_testPDObis', 'nom_testPDObis');

        // Test du connect
        //echo $user->connect('testPDObis', 'testPDObis');
        ...
        // Test du update
        //echo $user->update('testPDObis2', 'testPDObis2', 'testPDObis2@test.com', 'prenom_testPDObis2', 'nom_testPDObis2');
